...
void print_help() {
    ...
    std::cout << "Usage:\n"
                 ...
                 "  --adaptive-gain      RTL-SDR closed-loop gain on the ADC noise floor, from\n"
                 "                       49.6 dB (default unless a gain/AGC/stage is given)\n"
                 "  --no-adaptive-gain   Keep the fixed 49.6 dB default\n"
