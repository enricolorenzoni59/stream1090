...
struct CapturingHandler {
    ...
    std::array<Bits128, 8> frames{Bits128(), Bits128(), Bits128(), Bits128(),
                                  Bits128(), Bits128(), Bits128(), Bits128()};
};

Bits128 makePosition(uint32_t icao, bool odd, uint32_t latCpr, uint32_t lonCpr, uint8_t capability = 5) {
    const uint64_t high =
        (uint64_t(17) << 43) | (uint64_t(capability) << 40) | (uint64_t(icao) << 16) | (uint64_t(11) << 11);
    const uint64_t low = (uint64_t(odd) << 58) | (uint64_t(latCpr) << 41) | (uint64_t(lonCpr) << 24);
...
Bits128 makeIdentity(uint32_t icao, uint8_t capability = 5) {
    const uint64_t high =
        (uint64_t(17) << 43) | (uint64_t(capability) << 40) | (uint64_t(icao) << 16) | (uint64_t(5) << 11);
