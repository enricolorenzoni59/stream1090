...
inline bool checkICAO(const uint32_t& icao) {
    ...
    switch (first_4_bit) {
    case 0x0:
        return (0x004000 <= icao) && (icao <= 0x0DFFFF);
    case 0x1:
        return true;
    case 0x2:
        return (icao <= 0x20FFFF);
    case 0x3:
        return true;
    case 0x4:
        return (icao <= 0x4DFFFF);
    case 0x5:
        return (icao <= 0x51FFFF);
    case 0x6:
        return (icao <= 0x60FFFF) || ((0x680000 <= icao) && (icao <= 0x68FFFF));
    case 0x7:
        return true;
    case 0x8:
        return (icao <= 0x8AFFFF);
    case 0x9:
        return (icao <= 0x90FFFF);
    case 0xA:
        return true;
    case 0xC:
        return (icao <= 0xC3FFFF) || ((0xC80000 <= icao) && (icao <= 0xC9FFFF));
    case 0xE:
        return (icao <= 0xE9FFFF);
    default:
        return false;
    }
}
